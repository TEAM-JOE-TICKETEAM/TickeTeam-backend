...
public class TicketLettuceService {
    ...
    public ResultResponse issueTickets(TicketIssueRequest ticketIssueRequest) {
        ...
        Reservation newReservation = createAndSaveReservation(targetMatch, member, ticketIssueRequest.getPaymentId());
        ...
        for (Seat seat : seats) {
            ...
            stringRedisTemplate.delete(holdKey); // <-- 수정
        }
    ...
    private Reservation createAndSaveReservation(Game targetMatch, Member member, Long paymentId) {
