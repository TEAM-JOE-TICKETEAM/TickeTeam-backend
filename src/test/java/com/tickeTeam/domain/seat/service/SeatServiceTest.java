...
//
//    @Mock
//    private BlockSeatsResponse mockBlockSeatsResponse;
//
//    @InjectMocks
...
//    void 경기_좌석_조회_성공(){
//        try(MockedStatic<BlockSeatsResponse> mockedResponse = mockStatic(BlockSeatsResponse.class)) {
//            // 준비
...
//
//            mockedResponse.when(() -> BlockSeatsResponse.of(
//                    eq(mockSeats), eq(testGameId), eq("잠실 야구장")
//            )).thenReturn(mockBlockSeatsResponse);
//
//            // 실행
//            BlockSeatsResponse resultResponse = seatService.getBlockSeats(testGameId);
//
//            // 검증
...
//            mockedResponse.verify(() -> BlockSeatsResponse.of(
...
//                    eq(mockSeats), eq(testGameId), eq("잠실 야구장")
//            )).thenReturn(mockBlockSeatsResponse);
//            when(mockBlockSeatsResponse.getSeats()).thenReturn(Collections.emptyList());
//
//            // 실행
//            BlockSeatsResponse blockSeatsResponse = seatService.getBlockSeats(testGameId);
//
//            // 검증
//            assertThat(blockSeatsResponse).isNotNull();
////            assertThat(resultResponse.getMessage()).isEqualTo(ResultCode.GET_GAME_SEAT_SUCCESS.getMessage());
////            assertThat(resultResponse.getCode()).isEqualTo(ResultCode.GET_GAME_SEAT_SUCCESS.getCode());
////            assertThat(resultResponse.getData()).isEqualTo(mockGameSeatsResponse);
//
//            assertThat(blockSeatsResponse.getSeats()).isEqualTo(Collections.emptyList());
//
//            verify(gameRepository).findById(testGameId);
//            verify(seatRepository).findAllByGameAndSeatStatus(mockGame, SeatStatus.AVAILABLE);
//            mockedResponse.verify(() -> BlockSeatsResponse.of(
...
//
//        // 실행 & 검증
//        assertThatThrownBy(() -> seatService.getBlockSeats(testGameId))
